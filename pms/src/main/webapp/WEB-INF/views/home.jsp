...
<body>
		...
		<div id="two_cont">
			...
			<ul>
				<c:forEach items="${result}" var="res">
					<li><img src="resources/img/2000_5cdd2aeec5281.jpg"
						width="230px" height="150px" />
						<p>${res.pro_title}</p> <em>${res.pro_startdate} -
							${res.pro_enddate} / 서울시 강동구 새둘레길 89-1</em> <%-- <p class="cont">${res.pro_content}</p> --%>
						<button onclick="goDetail();">더 보기</button></li>
				</c:forEach>
			</ul>
	...
	<div id="sideBar">
		...
		<ul>
			...
			<li><span><a href="/join.do">회원가입</a></span></li>
		</ul>
		<hr />
	</div>
